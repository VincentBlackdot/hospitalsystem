  ...
  <div class="container-fluid">
  	<div class="col-md-12">
  		<div class="row">
  			...
  			<div class="col-md-10">
  				<h5 class="my-3">Patient Dashboad</h5>
  						...
  						<div class="col-md-3 bg-info mx-2" style="height: 150px;">
  							...
  							<div class="col-md-12">
  								<div class="row">
  									...
  									<div class="col-md-4">
  										<a href="#">
  											<i class="fa fa-user-circle fa-3x my-4" style="color: white;"></i></a>
  						...
  						<div class="col-md-3 bg-warning mx-2" style="height: 150px;">
  								...
  								<div class="row">
  									...
  									<div class="col-md-4">
  										<a href="appointment.php">
  											<i class="fa fa-calendar fa-3x my-4" style="color: white;"></i></a>
  							...
  							<div class="col-md-3 bg-success mx-2" style="height: 150px;">
  								...
  								<div class="row">
  									...
  									<div class="col-md-4">
  										<a href="invoice.php">
  											<i class=" fas fa fa-file-invoice-dollar fa-3x my-4" style="color: white;"></i></a>
  				   ...
  				   <div class="col-md-12">
  				   	<div class="row">
  				   		...
  				   		<div class="col-md-6 jumbotron bg-info my-5">
  				   			...
  				   			<form method="post"><br>
  				   				<label>Title</label>
  				   				<input type="text" name="title" autocomplete="off" placeholder="Enter Title of the report"><br>
