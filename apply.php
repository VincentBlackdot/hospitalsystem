...
if (isset($_POST['apply'])) {
	...
	if (empty($firstname)) {
		...
		$error['apply'] = "Enter Email Addrress";
	}else if ($gender ==""){
...
<body style="background-image: url(img/hospitalbg.jpg); background-size: cover; background-repeat: no-repeat;">
			...
			<div class="row">
				...
				<div class="col-md-6 my-3 jumbotron">
					...
					<form method="post">
						...
						<div class="form-group">
							<label>Email</label>
							<input type="email" name="email" class="form-control" autocomplete="off" placeholder="Enter Email Addrress" value=" <?php if(isset($_POST['email'])) echo $_POST['email']; ?>">	
						</div>
